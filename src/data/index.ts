export const teamRows = [
  ...
  },
  {
    id: 25,
    name: "Yasmeen Adel",
    email: "yasmeen.a@test.com",
    age: 28,
    phone: "0106566778",
    access: "User",
  },
];
export const contactsRows = Array.from({ length: 25 }, (_, i) => ({
  id: i + 1,
  name: `Person ${i + 1}`,
  email: `person${i + 1}@test.com`,
  age: 20 + (i % 30),
  phone: `010${(i + 1).toString().padStart(7, "0")}`,
  address: `${100 + i} New Street`,
  city: ["Cairo", "Giza", "Alexandria", "Aswan", "Mansoura"][i % 5],
  zipCode: `${11111 + i}`,
}));
export const invoicesRows = Array.from({ length: 25 }, (_, i) => ({
  id: i + 1,
  name: `Person ${i + 1}`,
  email: `person${i + 1}@test.com`,
  phone: `010${(i + 1).toString().padStart(7, "0")}`,
...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Yes, we ship to multiple countries. Shipping fees and times vary by location.",
  },
  {
    question: "How can I contact customer support?",
    answer:
      "You can reach us via email at support@ecommerce.com or through our contact form.",
  },
  {
    question: "Are my payment details secure?",
    answer:
      "Yes, we use industry-standard encryption to ensure your payment details are safe.",
  },
  {
    question: "How do I cancel my order?",
    answer:
      "Orders can be canceled within 24 hours of purchase by contacting our support team.",
  },
  {
    question: "Can I change my shipping address after placing an order?",
    answer:
      "You can update your shipping address within 12 hours of placing your order.",
  },
  {
    question: "Do you offer discounts or promotions?",
    answer:
      "Yes, we frequently offer discounts. Subscribe to our newsletter for exclusive offers.",
  },
  {
...
export const smallPieChartData1 = [
  {
    id: "erlang",
    label: "erlang",
    value: 364,
...
export const smallPieChartData2 = [
  {
    id: "php",
    label: "php",
    value: 371,
...
export const smallPieChartData3 = [
  {
    id: "sass",
    label: "sass",
    value: 156,
...
export const smallPieChartData4 = [
  {
    id: "javascript",
    label: "javascript",
    value: 500,
